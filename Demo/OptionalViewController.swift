...
private extension Selector {
    static let saveButtonTapped = #selector(OptionalViewController.saveButtonTapped(_:))
}

final class OptionalViewController: MSFormTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            let cell = MSFormCell(maxTextCount: 10, isOptional: true, textChanged: { (text) in
                self.user.name = text
            }, didReturn: {
        ...
        case 1:
            ...
            let cell = MSFormCell(isOptional: true, pregError: ("Invalid format mail address", "[A-Z0-9a-z._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,4}"), textChanged: { (text) in
